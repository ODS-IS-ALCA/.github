<img src="https://github.com/ODS-IS-ALCA/.github/blob/main/images/ODS_Logo.png" width="60%">

## Open Data Spaces ⾃動⾞ライフサイクルアセスメント 関連リポジトリ
...
「Automotive Life Cycle Assessment（ALCA）（⾃動⾞ライフサイクルアセスメント）」インダストリサービスでは、自動車ライフサイクルアセスメントにおけるデータ連携基盤を実装するための各種ライブラリやツール類を共創しています。

インダストリサービスの関連リポジトリは、[こちら](https://github.com/orgs/ODS-IS-ALCA/repositories)から。
